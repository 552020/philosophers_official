...
typedef enum death_state_e { EVERYONE_ALIVE = 0, SOMEONE_DIED } t_death_state;
...
typedef enum e_hunger_check { ON = 0, OFF } t_hunger_check;
...
void init_sim_param(t_simulation_parameters *sim_params, int argc, char **argv);
